...
@Component({
  selector: 'app-detaidaduyet',
  templateUrl: './detaidaduyet.component.html',
  styleUrls: ['./detaidaduyet.component.css',
...
export class DetaidaduyetComponent {
  listSubjects: any;
  listMasters: any;
  ...
  ngOnInit() {
    this.subjectService
      ...
      .subscribe((response) => {
        ...
        this.masterService
          .getMasterBySubjectAndStatus(this.idSubject, '1', this.schoolYear)
          .pipe(
            //Xử lý lỗi thì lữu dữ liệu lên sessionStorage
            catchError((error) => throwError(error.error))
          )
